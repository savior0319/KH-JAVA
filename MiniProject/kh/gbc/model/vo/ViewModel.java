...
public class ViewModel {
	...
	/*
	 * 0-> LobbyPanel 1-> AdventurePanel 2-> PowerUpPanel
	 */
	...
	public String getPowerLvUpName() {
		return "lvUp";
	}

	public String getPowerNewAdventureName() {
		return "adventureNew";
	}

	public String getPowerNewFeedName() {
		return "feedNew";
	}
	...
	public void setPanel(String viewName, JPanel p) {
		panelList.put(viewName, p);
	}

	public JPanel getPanel(String viewName) {
		return panelList.get(viewName);
	}

	public void setLobbyPanel(JPanel lobbyView) {
	...
	public void setButton(JButton p) {
		btnList.add(p);
	}

	public JButton getButton(int bIndex) {
		return btnList.get(bIndex);
	}

	public void setGBCLabel(JLabel gbcImg) {
		this.gbcImg = gbcImg;
	}

	public JLabel getGBCLabel() {
		return this.gbcImg;
	}
