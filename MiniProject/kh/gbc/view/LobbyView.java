...
public class LobbyView {
	...
	public void loadLobbyView() {
		...
		adventureBtn.addActionListener(e -> {
			lobbyCtl.advBtnAction();
		});
		...
		powerUpBtn.addActionListener(e -> {
			lobbyCtl.pwUpBtnAction();
		});
		...
		recomaandBtn.addActionListener(e -> {
			lobbyCtl.optionBtnAction();
		});
	...
	public void initProgressValue(int progressVal) {
