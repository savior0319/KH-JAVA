...
public class AdventureView {
	...
	public void adventureConfirm()
	{
		...
		case 1: eventImage.setIcon(new ImageIcon(resRoad.getEventImg01().getScaledInstance(360, 200, Image.SCALE_SMOOTH))); break;
		case 2: eventImage.setIcon(new ImageIcon(resRoad.getEventImg02().getScaledInstance(360, 200, Image.SCALE_SMOOTH))); break;
		case 3: eventImage.setIcon(new ImageIcon(resRoad.getEventImg03().getScaledInstance(360, 200, Image.SCALE_SMOOTH))); break;
		case 4: eventImage.setIcon(new ImageIcon(resRoad.getEventImg04().getScaledInstance(360, 200, Image.SCALE_SMOOTH))); break;
		}
		
		String msg = null; // 여기 추가
		
		switch(this.select) { // 여기 추가
			case 1: msg = "<html>잠깐, 이이런.. 수면이 아프잖아 이거<br>" + "절대... 우, 우, 우아아아<br>" + "아아아아아아아아아아아아</html>"; break;
			case 2: msg = "<html>...깊이 잠수하여 물고기<br>" + "많이 먹자-...탓<br>" + "쭉쭉 잠수한다-..이런 차가워</html>"; break;
			case 3: msg = "<html>바다 뒷편의 물고기를<br>" + "..한 번에 먹자-... 탓!<br>" + "..이런.. 힘을 너무 냈다...</html>"; break;
			case 4: msg = "<html>...일광욕으로 기생충을<br>" + "많이 잡자-! 푸하!<br>" + "..어어 꾸벅거리기 시작...</html>"; break;
		}
...
//		uc.message(messageLabel,msg);
	...
	public void loadAdventureView() {
	   ...
	   public void loadAdventureView(int select)
	   {
	      ...
	      switch(select)
	      {
	         case 1:event = "Event 01"; break;
	         case 2:event = "Event 02"; break;
	         case 3:event = "Event 03"; break;
	         case 4:event = "Event 04"; break;
	      }
	      ...
	      switch(select)
	      {
	         case 1:eventImgLabel.setIcon(new ImageIcon(resRoad.getAdventureMomGaryupImg())); break;
	         case 2:eventImgLabel.setIcon(new ImageIcon(resRoad.getAdventureDeepBlueImg())); break;
	         case 3:eventImgLabel.setIcon(new ImageIcon(resRoad.getAdventureRockImg())); break;
	         case 4:eventImgLabel.setIcon(new ImageIcon(resRoad.getAdventureLightImg())); break;
	      }
	      ...
	      switch(select)
	      {
	         case 1:htmlText = "<html>몸이 가렵다.<br>" + "아무리 생각해도 기생충 같다.<br>" + "수면에 점프하면<br>" 
	                        + "기생충을 떨어뜨릴 수 있을 것 같다.<br>" + "단지 점프의 충격은 제법 아플지도.<br>" + "어떻게 하지?"; break;
	         case 2:htmlText = "<html>깊은 곳까지 헤엄쳐 왔습니다.<br>" + "이대로 진행하면 맛있는 먹이가 보일지도.<br>" + "단지 이 이상 진행하면 위험할지도 몰라.<br>" + "어떻게 하지?"; break;
	         case 3:htmlText = "<html>눈 앞에 큰 바위가.<br>" + "저 바위의 뒷편에는 많은 먹이가 있을 것 같다.<br>" + "힘을 내서 먹이까지 대쉬!<br>" 
	                           + "단지 뭔가 싫은 기분이 든다...<br>" + "어떻게 하지?"; break;
	         case 4:htmlText = "<html>이런, 아침해다. 따뜻하고<br>" + "먹이도 정말 많을 것 같아.<br>" + "아침해를 향해 버텨볼까? 그것도 나쁘지 않아<br>" + "어떻게 하지?"; break;
	      }
	      ...
	      giveUpBtn = vm.fitImageBtn(giveUpBtn);
	      giveUpBtn.setBounds(70,440,130,50);
	      giveUpBtn.addActionListener(e-> { advCon.backtoLobby();});
	      
	      progreesBtn = new JButton(new ImageIcon(resRoad.getRedBtn()));
	      progreesBtn = vm.fitImageBtn(progreesBtn);
	      progreesBtn.setBounds(220,440,130,50);
	      progreesBtn.addActionListener(e->{advCon.goAdventure();});
